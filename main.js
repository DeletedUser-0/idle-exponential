...
var save = {
	...
	Update1Reducer: new Decimal(-0.05),
	var1: new Decimal(0.95),
	Update1ReducerReducer: new Decimal(1.06),
...
function Upgrade3() {
	if (save.OldIP.mantissa >= save.Upgrade3Cost.mantissa && save.OldIP.exponent >= save.Upgrade3Cost.exponent) {
		save.Update1 = Decimal.times(save.Update1, save.var1);
		save.Update1Reducer = Decimal.divide(save.Update1Reducer, save.Update1ReducerReducer);
		save.var1 = Decimal.add(save.Update1, 1);
		...
		document.getElementById('Upgrade3').innerHTML = "Decrease Tickspeed. <br> Currently: " + notate(save.Update1) + "ms. <br> Cost: " + notate(save.Upgrade3Cost) + " IP <br> Level: " + notate(save.Upgrade3Level);
	};
};
